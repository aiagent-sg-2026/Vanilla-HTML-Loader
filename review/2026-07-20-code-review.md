...
#### 1. Large CSS file (886 lines)
- **Location**: `css/components.css`
- **Category**: maintainability
- **Evidence**: 886 lines
- **Suggestion**: Split into smaller component-scoped CSS files.

> This CSS file has 886 lines. Large CSS files are harder to maintain and can slow initial render.
...
#### 1. Repeated hardcoded pixel values (e.g. 1px used 30×)
- **Location**: `css/components.css`
- **Category**: duplication
- **Evidence**: 1px ×30, 44px ×28, 8px ×27
...
| --- | --- |
| filesScanned | 34 |
| totalFilesInProject | 58 |
| totalSizeBytes | 163444 |
| findingsTotal | 8 |
| findingsCritical | 0 |
| findingsHigh | 4 |
| findingsMedium | 3 |
