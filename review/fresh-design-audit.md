...
| medium | spacing | spacing-drift | 61 distinct margin/padding/gap values found. | Use a spacing scale such as 4, 8, 12, 16, 24, 32px and reference it through CSS variables. |
