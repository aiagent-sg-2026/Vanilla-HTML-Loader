...
Last verified against code: 2026-08-05. Task-level detail lives in [TASK.md](TASK.md); timeline in [ROADMAP.md](ROADMAP.md).

| Epic | Title | Status |
| --- | --- | --- |
| E1 | Studio shell & modular architecture | ✅ Done |
| E2 | Collection performance at scale | ✅ Done |
| E3 | Loader library expansion (30 → 1146) | ✅ Done (open-ended: new packs welcome) |
...
Grow the registry from 30 (post-refactor) to **1146** loaders in 17 categories through 10-loader packs, each with its own QA + review record in `review/`.
