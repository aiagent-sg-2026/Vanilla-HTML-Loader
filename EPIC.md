...
| E3 | Loader library expansion (30 → 565) | ✅ Done (open-ended: new packs welcome) |
...
Grow the registry from 30 (post-refactor) to **565** loaders in 15 categories through 10-loader packs, each with its own QA + review record in `review/`.
