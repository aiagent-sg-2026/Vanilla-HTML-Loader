...
| E3 | Loader library expansion (30 → 1102) | ✅ Done (open-ended: new packs welcome) |
...
Grow the registry from 30 (post-refactor) to **1102** loaders in 17 categories through 10-loader packs, each with its own QA + review record in `review/`.
