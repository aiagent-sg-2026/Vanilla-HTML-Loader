...
#### 1. Large script file (309 lines)
- **Location**: `loaders/common-operation-loaders-3.js`
- **Category**: maintainability
- **Evidence**: 309 lines
- **Suggestion**: Split into smaller single-responsibility modules.

> This file has 309 lines. Oversized scripts are harder to test and maintain.
...
| --- | --- |
| filesScanned | 4 |
| totalFilesInProject | 155 |
| totalSizeBytes | 29160 |
| findingsTotal | 1 |
| findingsCritical | 0 |
| findingsHigh | 0 |
| findingsMedium | 1 |
